...
public class TaskService {
    ...
    public Task findById(Long id) {
        ...
        // Se a tarefa existir, retorna o objeto, se estiver vazio, lança um
        // RunTimeException
        return task.orElseThrow(() -> new RuntimeException(
                "Task não encontrada! ID:" + id + ",Tipo:" + Task.class.getName()));
    }

    // Método para buscar todas as tarefas vinculadas a um usuário apartir do ID do
    // usuário
    public List<Task> findByUserId(Long userId) {

        // Chama o UserService para garantir que o usuário existe no banco(lança exceção
        // caso não exista)
    ...
    public void delete(long id) {
        ...
        try {
            ...
            // Captura execções (como violação de integridade referencial) e lança uma
